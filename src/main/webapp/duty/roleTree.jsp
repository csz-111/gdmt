...
<script type="text/javascript">
    ...
    $(function () {
        $.get('${pageContext.request.contextPath}/duty/findAllRole.do', {}, function (list) {
            for (var i = 0; i < list.length; i++) {
                $('#in').append('<li><span id="' + list.role_uuid + '"><i class="icon-folder-open"></i> ' + list.role_name + '</span><ul>' + html_in + '</ul></li>');
            }
