...
<script type="text/javascript">
    $(function () {
        $('#duty_table').bootstrapTable({
            url: '${pageContext.request.contextPath}/duty/findAll.do',
            method: 'get',
            striped: true,
            cache: false,
            pagination: true,
            ...
            columns: [{field: 'name', title: '岗位名称', width: 200},
                // { field : 'orgName', title : '组织信息', width : 200},
                // { field : 'roleName', title : '角色信息', width : 200},
                {field: 'organization.organ_name', title: '组织信息', width: 200},
                {field: 'role.role_name', title: '角色信息', width: 200},
                {
                    field: 'dutyId', title: '操作', width: 100, align: 'center', formatter:
                        function actionFormatter(value, row, index) {
                            var result = '';
                            result += '<a href="#" class="btn btn-sm" onclick="updateDuty(\'' + row.dutyid + '\')"><span class="fa fa-edit"></span>&nbsp;编辑</a>';
                            result += '<a href="#" class="btn btn-sm" onclick="deleteDuty(\'' + row.dutyid + '\')"><span class="fa fa-trash-o"></span>&nbsp;删除</a>';
                            return result;
                        }
                }
            ],
