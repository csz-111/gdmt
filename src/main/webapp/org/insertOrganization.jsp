            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <div class="radio icheck-silver icheck-inline">
                        <input type="radio" value="1" name="organ_type" id="organ_type1"><label
                            for="organ_type1">1</label>
                    </div>
                    <div class="radio icheck-silver icheck-inline">
                        <input type="radio" value="2" name="organ_type" id="organ_type2"><label
                            for="organ_type2">2</label>
                    </div>
                    <div class="radio icheck-silver icheck-inline">
                        <input type="radio" value="3" name="organ_type" id="organ_type3"><label
                            for="organ_type3">3</label>
                    </div>
                    <div class="radio icheck-silver icheck-inline">
                        <input type="radio" value="4" name="organ_type" id="organ_type4"><label
                            for="organ_type4">4</label>
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <div class="input-group mb15">
                        <input id="parent_name" class="form-control" type="text" name="parent_name"
                               placeholder="请输入父组织信息"/>
...
<script type="text/javascript">
    ...
    function submitForm() {
        ...
        $.post('${pageContext.request.contextPath}/org/insert.do', form, function (data) {
            debugger;
            if (data.success) {
