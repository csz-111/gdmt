...
<script type="text/javascript">
    $(function () {
        ...
        //初始化页面
        $.get('${pageContext.request.contextPath}/org/getOrg.do', {id: $('#organ_uuid').val()}, function (org) {
            console.log(org);
    ...
    function submitForm() {
        ...
        $.post('${pageContext.request.contextPath}/org/update.do', form, function (data) {
            debugger;
            if (data.success) {
