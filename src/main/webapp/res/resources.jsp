...
<script type="text/javascript">
    ...
    $(function () {
        $('#res_table').bootstrapTable({
            url: '${pageContext.request.contextPath}/res/findPagination.do',
            method: 'get',
            toolbar: '#toolbar',
            striped: true,
            cache: false,
            ...
            columns: [{checkbox: true, visible: true},
                {field: 'dir_code', title: '菜单编号', width: 120, align: 'center'},
                {field: 'dir_name', title: '菜单名称', width: 120, align: 'center'},
                {field: 'dir_level_number', title: '菜单级数', width: 120, align: 'center'},
                {field: 'dir_name', title: '父菜单名称', width: 120, align: 'center'},
                {field: 'isitem', title: '明细否', formatter: ifFormatter, width: 120, align: 'center'},
                {field: 'dir_order', title: '菜单顺序号', width: 120, align: 'center'},
                {field: 'locale', title: '语言类型', width: 120, align: 'center'},
                {field: 'parent.res_url', title: '资源路径', width: 120, align: 'center'}
            ],
