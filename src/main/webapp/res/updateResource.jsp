                ...
                <div class="col-sm-8">
                    <div class="input-group mb15">
                        <input id="parent_name" class="form-control" type="text" name="parent_name"
                               placeholder="请选择父菜单信息"/>
                        <input id="parent_id" type="hidden" name="parent_id"/>
                        <span class="input-group-addon" data-toggle="modal" data-target="#resTree"><i
...
<!-- 资源树 -->
<div id="resTree" class="modal fade" style="height: auto;" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        //初始化页面
        $.get('${pageContext.request.contextPath}/res/getResource.do', {uuid: $('#res_uuid').val()}, function (res) {
            debugger;
            $('#res_url').val(res.parent.res_url);
    ...
    function submitForm() {
        ...
        $.post('${pageContext.request.contextPath}/res/update.do', form, function (data) {
