...
<header>
    <div class="headerwrapper">
        <div class="header-left">
            <a href="index.jsp" class="logo"> <img src="picture/logo.png"
                                                   alt=""/></a>
...
-->
                <li class="parent"><a href="#"><i class="fa fa-users"></i>
                    <span>用户管理</span></a>
                    <ul class="children">
                        <li><a href="javascript:#" title="user/insertUser.jsp"
                               onclick="locationHtml(this)">新增用户信息</a></li>
                        <li><a href="javascript:#" title="user/users.jsp"
                               onclick="locationHtml(this)">浏览用户信息列表</a></li>
                    </ul>
                </li>

                <li class="parent"><a href="#"><i class="fa fa-sitemap"></i>
                    <span>组织管理</span></a>
                    <ul class="children">
                        <li><a href="javascript:#"
                               title="org/insertOrganization.jsp" onclick="locationHtml(this)">新增组织信息</a></li>
                        <li><a href="javascript:#" title="org/organizations.jsp"
                               onclick="locationHtml(this)">浏览组织信息列表</a></li>
                    </ul>
                </li>

                <li class="parent"><a href="#"><i class="fa fa-male"></i>
                    <span>权限管理</span></a>
                    <ul class="children">
                        <li><a href="javascript:#" title="role/insertRole.jsp"
                               onclick="locationHtml(this)">新增角色信息</a></li>
                        <li><a href="javascript:#" title="role/roles.jsp"
                               onclick="locationHtml(this)">浏览角色信息列表</a></li>
                        <li><a href="javascript:#" title="duty/insertDuty.jsp"
                               onclick="locationHtml(this)">新增岗位信息</a></li>
                        <li><a href="javascript:#" title="duty/duties.jsp"
                               onclick="locationHtml(this)">浏览岗位信息列表</a></li>
                    </ul>
                </li>

                <li class="parent"><a href="#"><i class="fa fa-database"></i>
                    <span>资源管理</span></a>
                    <ul class="children">
                        <li><a href="javascript:#" title="res/insertResource.jsp"
                               onclick="locationHtml(this)">新增资源信息</a></li>
                        <li><a href="javascript:#" title="res/resources.jsp"
                               onclick="locationHtml(this)">浏览资源信息列表</a></li>
                    </ul>
                </li>

                <li class="parent"><a href="#"><i class="fa fa-twitter"></i>
                    <span>资讯管理</span></a>
                    <ul class="children">
                        <li><a href="javascript:#" title="news/insertNews.jsp"
                               onclick="locationHtml(this)">新增资源信息</a></li>
                        <li><a href="javascript:#" title="news/newses.jsp"
                               onclick="locationHtml(this)">浏览资源信息列表</a></li>
                    </ul>
                </li>
        ...
        <div class="mainpanel">
            <div id="parent" class="contentpanel" style="height: 670px">
                <iframe id="myContainer" frameborder="0" scrolling="no"
                        width="100%" height="100%" src="context.jsp"></iframe>
            </div>
        </div>

        <div class="modal fade" id="_Modal" tabindex="-1" role="dialog"
