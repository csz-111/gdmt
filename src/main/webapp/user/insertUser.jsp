...
<body onload="window.parent.document.getElementById('myContainer').height=document.body.scrollHeight;">
...
<script type="text/javascript">
    ...
    function submitForm() {
        ...
        $.post('${pageContext.request.contextPath}/user/add.do', form, function (data) {
