    ...
    <div class="panel-body nopadding">
        <form id="orgForm" method="post" class="form-bordered">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <div class="input-group mb15">
                        <input id="parent_name" class="form-control" type="text" name="organ.organ_name"
                               placeholder="请选择组织信息"/>
                        <input id="parent_uuid" type="hidden" name="organ.organ_uuid"/>
                        <span class="input-group-addon" data-toggle="modal" data-target="#orgTree"><i
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <div class="radio icheck-silver icheck-inline">
                        <input type="radio" value="0" name="is_sum" id="is_sum1"><label for="is_sum1">否</label>
                    </div>
                    <div class="radio icheck-silver icheck-inline">
                        <input type="radio" value="1" name="is_sum" id="is_sum2"><label for="is_sum2">是</label>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        //初始化页面
        $.get('${pageContext.request.contextPath}/user/findOne.do', {uuid: $('#user_uuid').val()}, function (user) {
            ...
            //单选属性赋值
            $('input:radio[name=is_sum]')[user.is_sum].checked = true;
            ...
            if (user.duties != null || user.duties.length > 0) {
                ...
                $.get('${pageContext.request.contextPath}/duty/getDutyByOrganId.do', {organId: user.organ.organ_uuid}, function (data) {
                    var html = '';
    ...
    function submitForm() {
        ...
        $.post('${pageContext.request.contextPath}/user/update.do', form, function (data) {
            if (data.success) {
