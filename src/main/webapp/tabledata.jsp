...
<link href="${pageContext.request.contextPath}/css/table-panel.css" rel="stylesheet"/>
...
<link href="${pageContext.request.contextPath}/css/icheck-bootstrap.min.css" rel="stylesheet">
<style type="text/css">
    td {
        font-size: 13px;
    }
