...
<div class="wrapper">
    <div class="top">
        <div class="top_main">
            <ul>
                <li><a href="#" class="ser">客服中心</a>|<a href="#" style="cursor: default;">客服热线：
                    400-020-8000（非工作时间：15011089832）</a></li>
            </ul>
        </div>
    </div>
    <div class="clear"></div>
    ...
    <div class="main">
        <div class="biaoqian">
            当前位置：<a href="#" style="white-space: nowrap;">首页</a> &gt; <a href="#" class="lili-a">资讯中心</a> &gt; <a
                href="#" target="_blank">宏观政策</a> &gt; 正文
        </div>

        <div class="newsTex">
            <h1>${news.title }</h1>
            <div class="msgbar" align="center">
                发布时间： ${news.operatetime } &nbsp; 作者： ${news.author }&nbsp; 来源： ${news.source } &nbsp; 浏览次数：<span
                    id="views">${news.count }</span>
            </div>
            ...
            <div class="other">
                ...
                <ul style="padding-left: 0px; margin-left: 0px; text-align: left;">
                    ...
                    <li><strong>下一篇：</strong><a href="http://fuel.powerec.net/hgzc/10174.jhtml">国务院关税税则委员会关于试行开展对美加征关税商品排除工作的公告</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="youqing">
                <div style="margin-right: 1%;">
                    <p style="padding: 10px;">
                        <a href="http://www.chnenergy.com.cn/" target="_blank" class="news_index_bottom_href"
                           onclick="$.get(&#39;/friendlink_view.jspx?id=90&#39;)">
                            国家能源集团 <!--          --> <!--          -->
                        </a> <a href="http://www.cctd.com.cn/" target="_blank" class="news_index_bottom_href"
                                onclick="$.get(&#39;/friendlink_view.jspx?id=53&#39;)">
                        中国煤炭市场网 <!--          --> <!--          -->
                    </a> <a href="http://www.shcce.com/" target="_blank" class="news_index_bottom_href"
                            onclick="$.get(&#39;/friendlink_view.jspx?id=75&#39;)">
                        上海煤炭交易中心 <!--          --> <!--          -->
                    </a> <a href="https://www.e-shenhua.com/ec/" target="_blank" class="news_index_bottom_href"
                            onclick="$.get(&#39;/friendlink_view.jspx?id=76&#39;)">
                        神华煤炭交易网 <!--          --> <!--          -->
                    </a> <a href="http://www.yitaigroup.com/" target="_blank" class="news_index_bottom_href"
                            onclick="$.get(&#39;/friendlink_view.jspx?id=79&#39;)">
                        伊泰集团 <!--          --> <!--          -->
                    </a> <a href="http://www.sxcoal.com/" target="_blank" class="news_index_bottom_href"
                            onclick="$.get(&#39;/friendlink_view.jspx?id=52&#39;)">
                        中国煤炭资源网 <!--          --> <!--          -->
                    </a> <a href="http://e.ctctc.cn/" target="_blank" class="news_index_bottom_href"
                            onclick="$.get(&#39;/friendlink_view.jspx?id=54&#39;)">
                        太原煤炭交易中心 <!--          --> <!--          -->
                    </a> <a href="http://www.snctc.cn/" target="_blank" class="news_index_bottom_href"
                            onclick="$.get(&#39;/friendlink_view.jspx?id=55&#39;)">
                        陕西煤炭交易中心 <!--          --> <!--          -->
                    </a> <a href="http://www.cqcoal.com/" target="_blank" class="news_index_bottom_href"
                            onclick="$.get(&#39;/friendlink_view.jspx?id=70&#39;)">
                        秦皇岛煤炭网 <!--          --> <!--          -->
                    </a> <a href="http://www.imcec.cn/" target="_blank" class="news_index_bottom_href"
                            onclick="$.get(&#39;/friendlink_view.jspx?id=72&#39;)">
                        内蒙古煤炭交易中心 <!--          --> <!--          -->
                    </a> <a href="http://www.chinacoal.com/" target="_blank" class="news_index_bottom_href"
                            onclick="$.get(&#39;/friendlink_view.jspx?id=73&#39;)">
                        中煤集团 <!--          --> <!--          -->
                    </a> <a href="http://www.cnss.com.cn/" target="_blank" class="news_index_bottom_href"
                            onclick="$.get(&#39;/friendlink_view.jspx?id=74&#39;)">
                        中国海事服务网 <!--          --> <!--          -->
                    </a> <a href="http://www.dtcoalmine.com/" target="_blank" class="news_index_bottom_href"
                        ...
                        <!--          -->
                    </a> <a href="http://www.sse.net.cn/home" target="_blank" class="news_index_bottom_href"
...
<div class="footer">
    <div>
        <p class="footer_p">
            <a href="http://fuel.powerec.net/service/index.jhtml">客服中心</a>|<a
                href="http://fuel.powerec.net/contact/index.jhtml">联系我们</a>
        </p>
