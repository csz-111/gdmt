    ...
    <div class="panel-body nopadding">
        <form id="newsForm" method="post" class="form-bordered">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="source" name="source" value="中国煤炭资源网"
                           placeholder="请输入资讯来源">
                </div>
            </div>
            <div class="form-group">
...
<script type="text/javascript">
    window.parent.set_iFrame(1100);
    window.parent.setMainDivHeight('1200px');
    ...
    function submitForm() {
        ...
        $.post('${pageContext.request.contextPath}/news/insert.do', form,
            function (data) {
                if (data == 1) {
