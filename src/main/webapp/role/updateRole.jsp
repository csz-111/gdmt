...
<script type="text/javascript">
    ...
    $(function () {
        ...
        //初始化页面
        $.get('${pageContext.request.contextPath}/role/getRole.do', {uuid: $('#role_uuid').val()}, function (role) {
            debugger;
    ...
    function submitForm() {
        ...
        $.post('${pageContext.request.contextPath}/role/update.do', form, function (data) {
