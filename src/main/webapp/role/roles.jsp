...
<script type="text/javascript">
    ...
    function linkResource(id) {
        $('#roleId').val(id);
        $.get('${pageContext.request.contextPath}/role/getResources.do', {roleId: id}, function (data) {
            if (data.length > 0) {
    ...
    function saveResource() {
        ...
        $.get('${pageContext.request.contextPath}/role/linkResource.do', params, function (data) {
            if (data == 0) {
